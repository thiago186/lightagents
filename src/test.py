...
msg2 = Message(role=MessageRole.AI, type=MessageType.TEXT, content="Oi! Tudo bem?")

msg3 = Message(role=MessageRole.USER, type=MessageType.TEXT, content="Sim, e você?")

msg4 = Message(role=MessageRole.USER, type=MessageType.TEXT, content="Qual é meu nome?")
...
from src.utils.serializers import role_mapping_serializer
